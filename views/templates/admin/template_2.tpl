...
<div class="panel">
	<div class="row pagoefectivo-header">
		...
		<div class="col-xs-12 col-md-3 text-center">
			<a href="#" onclick="javascript:return false;" class="btn btn-primary" id="create-account-btn">{l s='Create an account' mod='pagoefectivo'}</a><br />
			{l s='Already have one?' mod='pagoefectivo'}<a href="#" onclick="javascript:return false;"> {l s='Log in' mod='pagoefectivo'}</a>
		</div>
	</div>
